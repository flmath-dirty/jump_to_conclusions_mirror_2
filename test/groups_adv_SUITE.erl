...
groups() ->
    [
     {gr1,[],[my_test_case_1]},
     {gr21,[],[{gr22,[],[my_test_case_2, my_test_case_1]}]},
...
all() -> 
    [my_test_case_1,%%testcase
     ...
     {gr2,[],[my_test_case_3, my_test_case_4]},%% inline group
...
my_test_case_3(_Config) -> 
    ct:pal("my_test_case_3 run"),
    ok.

my_test_case_4(_Config) -> 
    ct:pal("my_test_case_4 run"),
    ok.

my_test_case_5(_Config) -> 
    ct:pal("my_test_case_3 run"),
    ok.

my_test_case_6(_Config) -> 
    ct:pal("my_test_case_4 run"),
    ok.
