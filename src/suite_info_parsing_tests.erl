...
get_all_inline_1_test()->
	...
	[my_test_case_1, {group, gr12}, my_test_case_2, 
	 ...
	 {group, gr24}],
    Outputs =
	[{'$root_group',{[{['$root_group'],my_test_case_1},
			{['$root_group'],my_test_case_2},
			{['$root_group'],my_test_case_3},
			{['$root_group'],my_test_case_4}],
		       [{['$root_group'],gr12},
			{['$root_group'],gr34},
			{['$root_group'],gr24}]}}],
...
get_all_inline_2_test()->
    ...
    Outputs = [{gr12,{[{[gr12],my_test_case_5},{[gr12],my_test_case_6}],
	       ...
	       {'$root_group',{[{[gr2,'$root_group'],my_test_case_3},
			      {[gr2,'$root_group'],my_test_case_4},
			      {['$root_group'],my_test_case_1}],
			     [{['$root_group'],gr1}]}}],
...
get_all_flat_adv_1_test()->
    ...
    Outputs =
	[{'$root_group',[{[gr2,gr3,'$root_group'],my_test_case_3},
		       {[gr2,gr3,'$root_group'],my_test_case_4},
		       {[gr3,'$root_group'],my_test_case_2},
		       {['$root_group'],my_test_case_1},
		       {[gr24,gr32,'$root_group'],my_test_case_2},
		       {[gr24,gr32,'$root_group'],my_test_case_4},
		       {[gr32,'$root_group'],my_test_case_3},
		       {[gr22,gr21,'$root_group'],my_test_case_1},
		       {[gr22,gr21,'$root_group'],my_test_case_2},
		       {[gr1,'$root_group'],my_test_case_1},
		       {[gr12,gr3,'$root_group'],my_test_case_6},
		       {[gr12,gr3,'$root_group'],my_test_case_5}]},
	 {gr12,[{[gr12],my_test_case_5},{[gr12],my_test_case_6}]},
	 {gr21,[{[gr22,gr21],my_test_case_2},
		{[gr22,gr21],my_test_case_1}]},
	 {gr1,[{[gr1],my_test_case_1}]},
